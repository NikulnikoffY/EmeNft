import {
  require_jsx_runtime
} from "./chunk-3H2KG4Z5.js";
import {
  __commonJS,
  __require,
  __toESM,
  require_react
} from "./chunk-XUXC73WF.js";
...
function createConnectionInfo(version, wallet) {
  ...
  return {
    ...
    auth_type: authType,
    custom_data: Object.assign({ chain_id: (_g2 = (_f2 = wallet === null || wallet === void 0 ? void 0 : wallet.account) === null || _f2 === void 0 ? void 0 : _f2.chain) !== null && _g2 !== void 0 ? _g2 : null, provider: (_h2 = wallet === null || wallet === void 0 ? void 0 : wallet.provider) !== null && _h2 !== void 0 ? _h2 : null }, createVersionInfo(version))
  };
}
  ...
  sendTransaction(transaction, optionsOrOnRequestSent) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const response = yield this.provider.sendRequest(sendTransactionParser.convertToRpcRequest(Object.assign(Object.assign({}, tx), {
        ...
        messages: messages.map((_a2) => {
          var { extraCurrency, payload, stateInit } = _a2, msg = __rest(_a2, ["extraCurrency", "payload", "stateInit"]);
  ...
  walletEventsListener(e2) {
    switch (e2.event) {
      case "connect":
        ...
        break;
      case "connect_error":
        this.tracker.trackConnectionError(e2.payload.message, e2.payload.code);
...
var TonConnectUIProvider = (_a2) => {
  ...
  return (0, import_jsx_runtime.jsx)(TonConnectUIContext.Provider, { value: tonConnectUI, children: children2 });
};
